AFRAME.registerComponent("showitem", {
    ...
    init: function() {
        ...
        let sounds = document.querySelectorAll(".itemsSound" + sessionStorage.getItem('lan'));
            ...
            if (el.firstElementChild.id != null) //check if this target has light
            {
                ...
                document.getElementById(sounds[randomSound].id).addEventListener('sound-ended', function() {
                    ...
                    if (sessionStorage.getItem('lan') == 'En') {
                        ...
                        item[random].lastElementChild.setAttribute("position", fairy.getAttribute("position"));

                        item[random].lastElementChild.components.sound.playSound();
                    }
                });
                if (sessionStorage.getItem('lan') == 'En') {
                    ...
                    item[random].lastElementChild.addEventListener('sound-ended', function() {

                        item[random].lastElementChild.parentNode.removeChild(item[random].firstElementChild);
                ...
                if (index == document.querySelectorAll(".Box").length) {
                    ...
                    item[random].firstElementChild.addEventListener('sound-ended', function() {
                        ...
                        document.getElementById("endAud" + sessionStorage.getItem('lan')).setAttribute("position", fairy.getAttribute("position"));

                        document.getElementById("endAud" + sessionStorage.getItem('lan')).components.sound.playSound();
