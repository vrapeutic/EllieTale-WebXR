AFRAME.registerComponent("ontriggertarget", {
    ...
    init: function() {
        ...
        var currentSound = "#infoSound" + sessionStorage.getItem('lan');
        ...
        let triggerTarget = () => {
                ...
                if (sounds[randomSound].getAttribute("src") != currentSound) {
                    sounds[randomSound].addEventListener('sound-ended', function() {
                        ...
                        fairy.children[2].components.sound.playSound();
                        // document.getElementById("boxAud2").components.sound.playSound();

                    });
                    fairy.children[2].addEventListener('sound-ended', function() {
                        ...
                        fairy.children[3].components.sound.playSound();
                        // document.getElementById("boxAud3").components.sound.playSound();

                    })
                    fairy.children[3].addEventListener('sound-ended', function() {

                        fairy.children[3].components.sound.stopSound();

                    })
                } else {
                    sounds[randomSound].addEventListener('sound-ended', function() {
                        document.getElementById("targetAud" + sessionStorage.getItem('lan')).components.sound.playSound();


                    });
                    document.getElementById("targetAud" + sessionStorage.getItem('lan')).addEventListener('sound-ended', function() {
                        document.getElementById("infoAud2" + sessionStorage.getItem('lan')).components.sound.playSound();


                    });
                    document.getElementById("infoAud2" + sessionStorage.getItem('lan')).addEventListener('sound-ended', function() {
                        document.getElementById("infoAud2" + sessionStorage.getItem('lan')).components.sound.stopSound();
