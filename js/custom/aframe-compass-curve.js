  ...
  init: function () {
    ...
    Array.prototype.getSortedIndex = function (value) {
      for (let index = 0; index < this.length - 1; index++) {
        ...
        if (this[index] <= value && value < this[index + 1]) return index;
      }
    ...
    let compassFunctions = {
      ...
      E: function (t) {
        return new THREE.Vector3(t, 0, 0);
      },
      W: function (t) {
        return new THREE.Vector3(-t, 0, 0);
      },
    ...
    let compassOffsets = {
      ...
      EN: new THREE.Vector3(1, 0, -1),
      NW: new THREE.Vector3(-1, 0, -1),
      WN: new THREE.Vector3(-1, 0, -1),
      SE: new THREE.Vector3(1, 0, 1),
      ES: new THREE.Vector3(1, 0, 1),
      SW: new THREE.Vector3(-1, 0, 1),
      WS: new THREE.Vector3(-1, 0, 1),
    };
    ...
    this.eval = function (t) {
      ...
      if (t >= currentTime) return currentPosition.clone();
