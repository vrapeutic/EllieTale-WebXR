        ...
        (module.exports = OverlapKeeper),
          ...
          (OverlapKeeper.prototype.set = function (i, j) {
            ...
            if (key !== current[index]) {
              for (j = current.length - 1; j >= index; j--)
    ...
    13: [
      function (require, module, exports) {
        ...
        var Vec3 = require("../math/Vec3"),
          ...
          Transform = require("../math/Transform"),
          RaycastResult =
            (require("../shapes/ConvexPolyhedron"),
            require("../shapes/Box"),
          ...
          (Ray.prototype.intersectShape = function (
            ...
            if (
              !(
                ...
                })(this.from, this._direction, position) >
        ...
        (Ray.prototype.intersectHeightfield = function (
          ...
          for (var i = iMinX; i < iMaxX; i++)
            for (var j = iMinY; j < iMaxY; j++) {
              ...
              if (
                (shape.getAabbAtIndex(i, j, aabb), aabb.overlapsRay(localRay))
              ) {
                if (
          ...
          for (
            ...
            if (!(Math.abs(dot) < this.precision)) {
              ...
              if (!(scalar < 0)) {
                ...
                for (
                  var i = 1;
                  !result._shouldStop && i < face.length - 1;
                  i++
                ) {
    ...
    16: [
      function (require, module, exports) {
        ...
        var PointToPointConstraint = require("./PointToPointConstraint"),
          ...
          RotationalEquation = require("../equations/RotationalEquation"),
          Vec3 =
            (require("../equations/ContactEquation"), require("../math/Vec3"));
        function ConeTwistConstraint(bodyA, bodyB, options) {
          var maxForce =
              void 0 !== (options = options || {}).maxForce
                ? options.maxForce
                : 1e6,
    ...
    20: [
      function (require, module, exports) {
        ...
        var PointToPointConstraint = require("./PointToPointConstraint"),
          RotationalEquation = require("../equations/RotationalEquation"),
          Vec3 =
            (require("../equations/RotationalMotorEquation"),
        ...
        (Mat3.prototype.identity = function () {
          ...
          (Mat3.prototype.solve = function (b, target) {
            ...
            if (
              ...
              (target.x =
                (eqns[3] - eqns[2] * target.z - eqns[1] * target.y) / eqns[0]),
              isNaN(target.x) ||
                isNaN(target.y) ||
                isNaN(target.z) ||
                target.x === 1 / 0 ||
          ...
          (Mat3.prototype.transpose = function (target) {
            for (
              var Mt = (target = target || new Mat3()).elements,
                M = this.elements,
                i = 0;
              3 !== i;
              i++
      ...
      function (require, module, exports) {
        ...
        (Quaternion.prototype.mult = function (q, target) {
          ...
          (Quaternion.prototype.conjugate = function (target) {
            return (
              ((target = target || new Quaternion()).x = -this.x),
              (target.y = -this.y),
              (target.z = -this.z),
              (target.w = this.w),
              target
        ...
        (Vec3.ZERO = new Vec3(0, 0, 0)),
          ...
          (Vec3.prototype.cross = function (v, target) {
            var vx = v.x,
              ...
              z = this.z;
            return (
              ((target = target || new Vec3()).x = y * vz - z * vy),
              (target.y = z * vx - x * vz),
              (target.z = x * vy - y * vx),
              target
            );
          ...
          (Vec3.prototype.vmul = function (vector, target) {
            return (
              ((target = target || new Vec3()).x = vector.x * this.x),
          ...
          (Vec3.prototype.addScaledVector = function (scalar, vector, target) {
            return (
              ((target = target || new Vec3()).x = this.x + scalar * vector.x),
          ...
          (Vec3.prototype.negate = function (target) {
            return (
              ((target = target || new Vec3()).x = -this.x),
              (target.y = -this.y),
              (target.z = -this.z),
              target
            );
    ...
    35: [
      function (require, module, exports) {
        ...
        var EventTarget = require("../utils/EventTarget"),
          ...
          Quaternion = require("../math/Quaternion"),
          AABB =
            (require("../material/Material"), require("../collision/AABB")),
          Box = require("../shapes/Box");
          ...
          (this.mass = mass),
            ...
            (this.sleepSpeedLimit =
              void 0 !== options.sleepSpeedLimit
                ...
                : 0.1),
            (this.sleepTimeLimit =
              void 0 !== options.sleepTimeLimit ? options.sleepTimeLimit : 1),
        ...
        (Body.prototype = new EventTarget()),
          ...
          (Body.prototype.vectorToLocalFrame = function (worldVector, result) {
            result = result || new Vec3();
            return (
              this.quaternion.conjugate().vmult(worldVector, result), result
            );
          }),
        ...
        Body.prototype.integrate = function (
          ...
          if (
            ...
            (angularVelo.x += dt * (e[0] * tx + e[1] * ty + e[2] * tz)),
              ...
              quatNormalize &&
                (quatNormalizeFast ? quat.normalizeFast() : quat.normalize()),
              (this.aabbNeedsUpdate = !0),
      ...
      function (require, module, exports) {
        ...
        function RaycastVehicle(options) {
          (this.chassisBody = options.chassisBody),
            ...
            (this.world = null),
            (this.indexRightAxis =
              void 0 !== options.indexRightAxis ? options.indexRightAxis : 1),
        ...
        RaycastVehicle.prototype.updateFriction = function (timeStep) {
          ...
          for (i = 0; i < numWheels; i++) {
            if ((groundObject = (wheel = wheelInfos[i]).raycastResult.body)) {
              var axlei = axle[i];
              this.getWheelTransformWorld(i).vectorToWorldFrame(
          ...
          for (i = 0; i < numWheels; i++) {
            ...
            if (((wheel.slipInfo = 1), groundObject)) {
              ...
              var factor =
                maxImpulse / (rollingFriction += wheel.engineForce * timeStep);
          ...
          if (this.sliding)
            for (i = 0; i < numWheels; i++) {
              0 !== (wheel = wheelInfos[i]).sideImpulse &&
                wheel.skidInfo < 1 &&
      ...
      function (require, module, exports) {
        ...
        (SPHSystem.prototype.update = function () {
          ...
          for (i = 0; i !== N; i++) {
            ...
            var neighbors;
            for (
              numNeighbors = (neighbors = this.neighbors[i]).length, j = 0;
              j !== numNeighbors;
              j++
            ) {
    ...
    42: [
      function (require, module, exports) {
        ...
        var Shape = require("./Shape"),
          Vec3 = require("../math/Vec3"),
          Transform =
            (require("../math/Quaternion"), require("../math/Transform"));
        ...
        ConvexPolyhedron.prototype.findSeparatingAxis = function (
          ...
          if (this.uniqueAxes)
            ...
            for (
              var numFacesA = faceListA ? faceListA.length : this.faces.length,
                i = 0;
              i < numFacesA;
              i++
            ) {
        ...
        (ConvexPolyhedron.prototype.clipFaceAgainstHull = function (
          ...
          if (!(closestFaceA < 0)) {
            ...
            pVtxIn.length;
            for (
              var numVerticesA = polyA.length, e0 = 0;
              e0 < numVerticesA;
              e0++
            ) {
            ...
            planeNormalWS.copy(localPlaneNormal),
              quatA.vmult(planeNormalWS, planeNormalWS);
            for (
              planeEqWS = localPlaneEq - planeNormalWS.dot(posA), i = 0;
              i < pVtxIn.length;
              i++
            ) {
        ...
        (ConvexPolyhedron.prototype.computeLocalAABB = function (
          ...
          (ConvexPolyhedron.prototype.computeWorldFaceNormals = function (
            quat
          ) {
            for (
    ...
    43: [
      function (require, module, exports) {
        ...
        var Shape = require("./Shape"),
          Vec3 = require("../math/Vec3"),
          ConvexPolyhedron =
            (require("../math/Quaternion"), require("./ConvexPolyhedron"));
        ...
        (Heightfield.prototype.getNormalAt = function (
          ...
          (Heightfield.prototype.getConvexTrianglePillar = function (
            ...
            if (this.cacheEnabled) {
              if (
                (data = this.getCachedConvexTrianglePillar(
                  xi,
                  yi,
                  getUpperTriangle
                ))
    ...
    48: [
      function (require, module, exports) {
        ...
        (Sphere.prototype = new Shape()),
          ...
          (Sphere.prototype.calculateWorldAABB = function (
            pos,
            quat,
            min,
            max
            ...
            for (iter = 0; iter !== maxIter; iter++) {
              ...
              for (var j = 0; j !== Neq; j++) {
                ...
                (B = Bs[j]),
                  ...
                  (lambdaj = lambda[j]) +
                    (deltalambda =
                      invC * (B - c.computeGWlambda() - c.eps * lambdaj)) <
                  c.minForce
      ...
      function (require, module, exports) {
        ...
        (module.exports = Utils),
          (Utils.defaults = function (options, defaults) {
            for (var key in ((options = options || {}), defaults))
      ...
      function (require, module, exports) {
        ...
        var AABB = require("../collision/AABB"),
          ...
          Quaternion =
            ...
            require("../math/Quaternion")),
          Vec3Pool =
            (require("../solver/Solver"), require("../utils/Vec3Pool")),
          ContactEquation = require("../equations/ContactEquation"),
          FrictionEquation = require("../equations/FrictionEquation");
            ...
            for (i = 0; i < triangles.length; i++)
              for (j = 0; j < 3; j++) {
                trimeshShape.getVertex(
                  ...
                  trimeshShape.getVertex(
                    trimeshShape.indices[3 * triangles[i] + ((j + 1) % 3)],
                    edgeVertexB
                  ),
        ...
        Narrowphase.prototype[
          ...
          for (
            var found = !1, nfaces = ((i = 0), faces.length);
            i !== nfaces && !1 === found;
            i++
          ) {
            ...
            if (
              ...
              if (pointInPolygon(faceVerts, worldNormal, xi)) {
                ...
                j = 0;
                for (var Nfaceverts = faceVerts.length; j !== Nfaceverts; j++)
              ...
              for (j = 0; j !== face.length; j++) {
                ...
                if (
                  ...
                  for (
                    j = 0, Nfaceverts = faceVerts.length;
                    j !== Nfaceverts;
                    j++
                  )
                    v3pool.release(faceVerts[j]);
              ...
              for (j = 0, Nfaceverts = faceVerts.length; j !== Nfaceverts; j++)
                v3pool.release(faceVerts[j]);
            }
          }
        };
    ...
    60: [
      function (require, module, exports) {
        ...
        (World.prototype.internalStep = function (dt) {
          ...
          i = 0;
          for (var Nsubsystems = this.subsystems.length; i !== Nsubsystems; i++)
          ...
          for (var ncontacts = contacts.length, k = 0; k !== ncontacts; k++) {
            ...
            if (
              ...
              bi.velocity.norm2() + bi.angularVelocity.norm2() >=
                2 * Math.pow(bi.sleepSpeedLimit, 2) &&
          ...
          for (
            ...
            (bi = bodies[i])._wakeUpAfterNarrowphase &&
            ...
            (options.type = TYPE.SPHERE),
              (radius =
                options.fit !== FIT.MANUAL || isNaN(options.sphereRadius)
                  ? _computeRadius(root, _computeBounds(root))
    ...
    62: [
      function (require, module, exports) {
          ...
          mesh2shape = function (object, options) {
            ...
            if (options.type === Type.SPHERE)
              return (function (object, options) {
                ...
                return geometry
                  ? (geometry.computeBoundingSphere(),
                    new CANNON.Sphere(geometry.boundingSphere.radius))
                  : null;
              })(object, options);
            if (options.type === Type.HULL)
              return (function (object) {
                ...
                for (
                  faces = new Array(hull.faces.length), i = 0;
                  i < hull.faces.length;
                  i++
                )
                  faces[i] = [
            ...
            switch (
              geometry.metadata ? geometry.metadata.type : geometry.type
            ) {
              case "BoxGeometry":
            ...
            isFinite(box.min.lengthSq())
              ? ((shape = new CANNON.Box(
                ...
                (localPosition = box
                  ...
                  .getCenter()).lengthSq() && (shape.offset = localPosition),
                shape)
              : null
          );
        }
        function getGeometry(object) {
          ...
          return (
            (matrix = new THREE.Matrix4()).scale(object.scale),
        ...
        module.exports = (function () {
          ...
          function assignPoints(face, pointset, points) {
            ...
            pointset.sort(function (aItem, bItem) {
              return (
                (dots[aItem.x / 3] =
                  void 0 !== dots[aItem.x / 3]
                    ? dots[aItem.x / 3]
                    : norm.dot(suba.subVectors(aItem, p0))),
                (dots[bItem.x / 3] =
                  void 0 !== dots[bItem.x / 3]
                    ? dots[bItem.x / 3]
            ...
            for (
              ...
              index-- > 0 && dots[pointset[index].x / 3] > 0;
          ...
          function cull(face, points) {
            for (
              var currentFace,
                i = faces.length,
                visibleFaces = [face],
                apex = points.indexOf(face.visiblePoints.pop());
              i-- > 0;

            )
              (currentFace = faces[i]) !== face &&
                getNormal(currentFace, points).dot(
            ...
            if (1 === visibleFaces.length)
              (perimeter = [
                ...
                faceStack.indexOf(currentFace) > -1 &&
                  faceStack.splice(faceStack.indexOf(currentFace), 1),
                currentFace.visiblePoints &&
              ...
              for (; i-- > 0; ) {
                ...
                for (
                  ...
                  for (
                    ...
                    if (
                      ((edgeIndex = 0),
                      (compareFace = visibleFaces[j]) !== currentFace)
                    )
                      for (; edgeIndex < 3 && !isSharedEdge; )
                        (nextIndex = edgeIndex + 1),
                          ...
                          edgeIndex++;
                  (isSharedEdge && !hasOneVisibleFace) ||
                    (perimeter.push(a), perimeter.push(b)),
                    cEdgeIndex++;
                }
              }
            i = 0;
            for (var f, l = perimeter.length / 2; i < l; )
              assignPoints(
                (f = [perimeter[2 * i + 1], apex, perimeter[2 * i]]),
                allPoints,
                points
              ),
                faces.push(f),
          ...
          return function (geometry) {
            ...
            for (j = i = 6; i-- > 0; )
              for (j = i - 1; j-- > 0; )
                max < (dcur = extremes[i].distanceToSquared(extremes[j])) &&
                  ((max = dcur), (v0 = extremes[i]), (v1 = extremes[j]));
            for (i = 6, max = 0; i-- > 0; )
              (dcur = distSqPointSegment(v0, v1, extremes[i])),
                max < dcur && ((max = dcur), (v2 = extremes[i]));
            for (
              N = norm(v0, v1, v2), D = N.dot(v0), max = 0, i = NUM_POINTS;
              i-- > 0;

            )
              (dcur = Math.abs(points[i].dot(N) - D)),
                max < dcur && ((max = dcur), (v3 = points[i]));
            ...
            subaA.subVectors(v1, v0).normalize(),
              ...
              subC.dot(new THREE.Vector3().crossVectors(subaB, subaA)) < 0 &&
            ...
            for (var i = tetrahedron.length; i-- > 0; )
              assignPoints(tetrahedron[i], pointsCloned, points),
                void 0 !== tetrahedron[i].visiblePoints &&
