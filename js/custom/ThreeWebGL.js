    ...
    for (g = C.faces.length; e < g; e++) {
      ...
      r =
        h instanceof THREE.Face4
          ? r.multiplyVector3(F[h.d].position.clone())
          : null;
      ...
      if (b.doubleSided || (b.flipSided ? E > 0 : E < 0)) {
        ...
        if (h instanceof THREE.Face3) {
          if (d(G, p, o, q)) {
            h = {
              distance: this.origin.distanceTo(G),
              point: G,
              face: h,
              object: b,
            };
...
THREE.Rectangle = function () {
  ...
  this.instersects = function (r) {
    return (
      ...
      Math.min(h, r.getBottom()) - Math.max(e, r.getTop()) >= 0
    );
  };
  this.empty = function () {
    q = !0;
...
THREE.Geometry.prototype = {
  ...
  computeFaceNormals: function (b) {
    ...
    for (h = this.faces.length; g < h; g++) {
      ...
      if (b && p.vertexNormals.length) {
        q.set(0, 0, 0);
        d = 0;
        for (e = p.vertexNormals.length; d < e; d++)
          q.addSelf(p.vertexNormals[d]);
        q.divideScalar(3);
      } else {
        d = this.vertices[p.a];
        e = this.vertices[p.b];
  ...
  computeTangents: function () {
    ...
    for (e = this.faces.length; d < e; d++) {
      ...
      if (p instanceof THREE.Face3) b(this, p.a, p.b, p.c, 0, 1, 2);
    ...
    for (e = this.faces.length; d < e; d++) {
      ...
      for (g = 0; g < p.vertexNormals.length; g++) {
        ...
        h = xa.dot(ha[h]);
        h = h < 0 ? -1 : 1;
        p.vertexTangents[g] = new THREE.Vector4(ia.x, ia.y, ia.z, h);
      }
    }
    this.hasTangents = !0;
  },
  ...
  computeBoundingSphere: function () {
    for (
      var b = this.boundingSphere === null ? 0 : this.boundingSphere.radius,
        d = 0,
...
THREE.Spline = function (b) {
  function d(C, F, O, P, L, ea, W) {
    ...
    P = (P - F) * 0.5;
    return (
      (2 * (F - O) + C + P) * W + (-3 * (F - O) - 2 * C - P) * ea + C * L + F
    );
  }
  this.points = b;
  var e = [],
  ...
  this.initFromArray = function (C) {
    ...
    for (var F = 0; F < C.length; F++)
      this.points[F] = { x: C[F][0], y: C[F][1], z: C[F][2] };
  };
...
THREE.MeshBasicMaterial = function (b) {
  ...
  this.refractionRatio =
    b.refractionRatio !== undefined ? b.refractionRatio : 0.98;
  this.shading = b.shading !== undefined ? b.shading : THREE.SmoothShading;
  this.wireframe = b.wireframe !== undefined ? b.wireframe : !1;
  this.wireframeLinewidth =
    b.wireframeLinewidth !== undefined ? b.wireframeLinewidth : 1;
  this.wireframeLinecap =
    b.wireframeLinecap !== undefined ? b.wireframeLinecap : "round";
...
THREE.MeshShaderMaterial = function (b) {
  ...
  b = b || {};
  this.fragmentShader =
    b.fragmentShader !== undefined ? b.fragmentShader : "void main() {}";
  this.vertexShader =
    b.vertexShader !== undefined ? b.vertexShader : "void main() {}";
...
THREE.ParticleBasicMaterial = function (b) {
  ...
  this.sizeAttenuation =
    b.sizeAttenuation !== undefined ? b.sizeAttenuation : !0;
  this.vertexColors = b.vertexColors !== undefined ? b.vertexColors : !1;
};
...
THREE.ShadowVolumeDynamicMaterial.prototype.constructor =
  THREE.ShadowVolumeDynamicMaterial;
  ...
  if (this.geometry.skinVerticesA === undefined) {
    ...
    for (b = 0; b < this.geometry.skinIndices.length; b++) {
      ...
      var h = this.geometry.skinIndices[b].x,
        p = this.geometry.skinIndices[b].y;
...
THREE.Sound.prototype.calculateVolumeAndPan = function (b) {
  ...
  this.domElement.volume =
    b <= this.radius ? this.volume * (1 - b / this.radius) : 0;
};
...
THREE.ShadowVolume.prototype.calculateShadowVolumeGeometry = function () {
  if (this.geometry.edges && this.geometry.edges.length) {
    ...
    var O = (F.egdes = this.geometry.edges),
      P = (F.edgeFaces = []);
    h = 0;
    var L = [];
    b = 0;
...
THREE.ShadowVolume.prototype.calculateShadowVolumeGeometryWithoutEdgeInfo =
  function (b) {
...
THREE.ShadowVolume.prototype.facesShareEdge = function (b, d, e) {
  ...
  for (F = 0; F < g; F++) {
    ...
    for (O = 0; O < h; O++) {
      ...
      r = b[o];
      if (
        Math.abs(q.position.x - r.position.x) < 1.0e-4 &&
        Math.abs(q.position.y - r.position.y) < 1.0e-4 &&
        Math.abs(q.position.z - r.position.z) < 1.0e-4
      ) {
        P++;
        if (P === 1) {
          v = q;
...
THREE.Sprite = function (b) {
  ...
  if (b.material !== undefined) {
    ...
    this.map =
      b.map instanceof THREE.Texture ? b.map : ImageUtils.loadTexture(b.map);
    this.material = undefined;
    this.blending =
      b.blending !== undefined ? b.blending : THREE.NormalBlending;
  }
  this.useScreenCoordinates =
    b.useScreenCoordinates !== undefined ? b.useScreenCoordinates : !0;
  this.mergeWith3D =
    b.mergeWith3D !== undefined ? b.mergeWith3D : !this.useScreenCoordinates;
  this.affectedByDistance =
    b.affectedByDistance !== undefined
...
THREE.Projector = function () {
  ...
  function e(T, c) {
    var ia = 0,
      ...
      $ = -T.z + T.w,
      qa = -c.z + c.w;
    if (ta >= 0 && ya >= 0 && $ >= 0 && qa >= 0) return !0;
    else if ((ta < 0 && ya < 0) || ($ < 0 && qa < 0)) return !1;
    else {
      if (ta < 0) ia = Math.max(ia, ta / (ta - ya));
      else ya < 0 && (xa = Math.min(xa, ta / (ta - ya)));
      if ($ < 0) ia = Math.max(ia, $ / ($ - qa));
      else qa < 0 && (xa = Math.min(xa, $ / ($ - qa)));
      if (xa < ia) return !1;
      else {
        T.lerpSelf(c, ia);
        c.lerpSelf(T, 1 - xa);
  ...
  this.projectObjects = function (T, c, ia) {
    ...
    for (xa = ta.length; T < xa; T++) {
      ...
      var $;
      if (!($ = !ya.visible))
        if (($ = ya instanceof THREE.Mesh)) {
          a: {
            $ = void 0;
            for (
              var qa = ya.matrixWorld,
                ra =
                  -ya.geometry.boundingSphere.radius *
                  Math.max(ya.scale.x, Math.max(ya.scale.y, ya.scale.z)),
                ja = 0;
              ja < 6;
              ja++
            ) {
  ...
  this.projectScene = function (T, c, ia) {
    ...
    fa[3].set(M.n41 - M.n21, M.n42 - M.n22, M.n43 - M.n23, M.n44 - M.n24);
    ...
    for ($ = Aa.length; T < $; T++) {
      ...
      if (ca.visible) {
        ...
        if (ca instanceof THREE.Mesh) {
          ...
          for (qa = fb.length; ja < qa; ja++) {
            ...
            if (ra instanceof THREE.Face3) {
              ...
              if (
                ...
                (ca.doubleSided ||
                  ca.flipSided !=
                    (sa.positionScreen.x - aa.positionScreen.x) *
                      (va.positionScreen.y - aa.positionScreen.y) -
                      (sa.positionScreen.y - aa.positionScreen.y) *
                        (va.positionScreen.x - aa.positionScreen.x) <
                      0)
              ) {
              ...
              if (
                ...
                (ca.doubleSided ||
                  ca.flipSided !=
                    ((za.positionScreen.x - aa.positionScreen.x) *
                      (va.positionScreen.y - aa.positionScreen.y) -
                      (za.positionScreen.y - aa.positionScreen.y) *
                        (va.positionScreen.x - aa.positionScreen.x) <
                      0 ||
                      (va.positionScreen.x - sa.positionScreen.x) *
                        (za.positionScreen.y - sa.positionScreen.y) -
                        (va.positionScreen.y - sa.positionScreen.y) *
                          (za.positionScreen.x - sa.positionScreen.x) <
                        0))
              ) {
          ...
          X.set(ca.matrixWorld.n14, ca.matrixWorld.n24, ca.matrixWorld.n34, 1);
          M.multiplyVector4(X);
          X.z /= X.w;
          if (X.z > 0 && X.z < 1) {
            ...
            L.scale.x =
              ...
              Math.abs(
                L.x -
                  (X.x + c.projectionMatrix.n11) /
                    (X.w + c.projectionMatrix.n14)
              );
            L.scale.y =
              ca.scale.y *
              Math.abs(
                L.y -
                  (X.y + c.projectionMatrix.n22) /
                    (X.w + c.projectionMatrix.n24)
              );
  ...
  clone: function (b) {
    ...
    for (d in b) {
      ...
      for (e in b[d]) {
        g = b[d][e];
        h[d][e] =
          g instanceof THREE.Color ||
          g instanceof THREE.Vector3 ||
...
THREE.WebGLRenderer = function (b) {
  ...
  function e(f, s, k, i, m) {
    ...
    if (
      ...
      (i instanceof THREE.MeshBasicMaterial ||
        ...
        i instanceof THREE.ParticleBasicMaterial ||
        i.fog)
    ) {
    ...
    if (
      ...
      var z,
        ...
        Q,
        da = Sa,
        Ga = da.directional.colors,
        Va = da.directional.positions,
        S = da.point.colors,
        U = da.point.positions,
        V = da.point.distances,
        pa = 0,
        t = 0;
      k = D = Q = 0;
    ...
    if (
      ...
      u.useRefract.value =
        i.envMap && i.envMap.mapping instanceof THREE.CubeRefractionMapping;
    }
    ...
    for (var I in u)
      if ((y = x.uniforms[I])) {
        ...
        n = z.type;
        k = z.value;
        if (n == "i") c.uniform1i(y, k);
        else if (n == "f") c.uniform1f(y, k);
        else if (n == "fv1") c.uniform1fv(y, k);
        else if (n == "fv") c.uniform3fv(y, k);
        else if (n == "v2") c.uniform2f(y, k.x, k.y);
        else if (n == "v3") c.uniform3f(y, k.x, k.y, k.z);
        else if (n == "v4") c.uniform4f(y, k.x, k.y, k.z, k.w);
        else if (n == "c") c.uniform3f(y, k.r, k.g, k.b);
        else if (n == "t") {
          c.uniform1i(y, k);
          if ((z = z.texture))
            if (z.image instanceof Array && z.image.length == 6) {
              if (z.image.length == 6) {
                if (z.needsUpdate) {
                  if (z.__webglInit) {
                    c.bindTexture(
                    ...
                    for (n = 0; n < 6; ++n)
                      c.texSubImage2D(
                        c.TEXTURE_CUBE_MAP_POSITIVE_X + n,
                        0,
                        0,
                        0,
                        c.RGBA,
    ...
    (i instanceof THREE.MeshShaderMaterial ||
      i instanceof THREE.MeshPhongMaterial ||
      i.envMap) &&
      w.cameraPosition !== null &&
      c.uniform3f(w.cameraPosition, f.position.x, f.position.y, f.position.z);
    (i instanceof THREE.MeshShaderMaterial || i.envMap || i.skinning) &&
      w.objectMatrix !== null &&
    ...
    if (i.skinning) {
      c.uniformMatrix4fv(w.cameraInverseMatrix, !1, Ya);
    ...
    if (i.opacity != 0) {
      ...
      if (!i.morphTargets && f.position >= 0) {
        ...
        if (x.morphTargetBase !== -1) {
          c.bindBuffer(
            c.ARRAY_BUFFER,
            m.__webglMorphTargetsBuffers[x.morphTargetBase]
          );
        ...
        if (x.morphTargetForcedOrder.length) {
          k = 0;
          for (
            var u = x.morphTargetForcedOrder, z = x.morphTargetInfluences;
            k < i.numSupportedMorphTargets && k < u.length;
          ...
          k = 0;
          for (
            x.morphTargetBase !== -1 && (u[x.morphTargetBase] = !0);
            k < i.numSupportedMorphTargets;
        ...
        i.program.uniforms.morphTargetInfluences !== null &&
          c.uniform1fv(
      ...
      if (i.attributes)
        for (w in i.attributes)
          if (f[w] !== undefined && f[w] >= 0) {
            s = i.attributes[w];
            if (s.buffer) {
    ...
    for (
      var s = f.matrixWorld,
        k =
          ...
          Math.max(f.scale.x, Math.max(f.scale.y, f.scale.z)),
        i = 0;
      i < 6;
      i++
    ) {
  ...
  function G(f) {
    ...
    for (i = x.materials.length; f < i; f++) {
      ...
      if (s instanceof THREE.MeshFaceMaterial) {
        s = 0;
        for (k = w.materials.length; s < k; s++)
          (m = w.materials[s]) && (m.transparent ? v(z, m) : v(u, m));
  ...
  function C(f) {
    ...
    var s,
      ...
      D,
      n,
      y = f.__webglShadowVolumes.length;
    for (s = 0; s < k; s++) {
      i = f.lights[s];
      if (i instanceof THREE.DirectionalLight && i.castShadow) {
        ...
        for (n = 0; n < y; n++) {
          ...
          c.vertexAttribPointer(D.position, 3, c.FLOAT, !1, 0, 0);
  ...
  function F(f, s) {
    ...
    for (i = f.__webglSprites.length; k < i; k++) {
      ...
      if (m.useScreenCoordinates) m.z = -m.position.z;
        ...
        m._modelViewMatrix.multiplyToArray(
          s.matrixWorldInverse,
          m.matrixWorld,
          m._modelViewMatrixArray
        );
      ...
      if (
        ...
        if (m.useScreenCoordinates) {
          ...
          c.uniform3f(
            ...
            (m.position.x - D) / D,
            (n - m.position.y) / n,
            Math.max(0, Math.min(1, m.position.z))
          );
        } else {
  ...
  function P(f, s) {
    f._modelViewMatrix.multiplyToArray(
      s.matrixWorldInverse,
      f.matrixWorld,
      f._modelViewMatrixArray
    );
    THREE.Matrix4.makeInvert3x3(f._modelViewMatrix).transposeIntoArray(
      f._normalMatrixArray
    );
  }
  function L(f) {
    var s, k, i, m, x;
    if (f instanceof THREE.Mesh) {
      ...
      for (s in k.geometryGroups) {
        ...
        x = !1;
        for (m in i.__webglCustomAttributes)
          if (i.__webglCustomAttributes[m].needsUpdate) {
            x = !0;
            break;
          }
        if (
          k.__dirtyVertices ||
          k.__dirtyMorphTargets ||
          k.__dirtyElements ||
          k.__dirtyUvs ||
          k.__dirtyNormals ||
          k.__dirtyColors ||
          ...
          if (i.__inittedArrays) {
            ...
            var Wa = void 0,
              ...
              Ca = 0;
            I = t = 0;
            var Da = i.__vertexArray,
              hb = i.__uvArray,
              ib = i.__uv2Array,
              Qa = i.__normalArray,
              ka = i.__tangentArray,
              Ea = i.__colorArray,
              la = i.__skinVertexAArray,
              ma = i.__skinVertexBArray,
              na = i.__skinIndexArray,
              oa = i.__skinWeightArray,
              jb = i.__morphTargetsArrays,
              Ra = i.__webglCustomAttributes;
            j = void 0;
            var Na = i.__faceArray,
              Oa = i.__lineArray,
              sb = i.__needsSmoothNormals;
            Q = i.__vertexColorType;
            Y = i.__uvType;
            da = i.__normalType;
            var Ha = x.geometry,
              kb = Ha.__dirtyVertices,
              lb = Ha.__dirtyElements,
              gb = Ha.__dirtyUvs,
              mb = Ha.__dirtyNormals,
              nb = Ha.__dirtyTangents,
              ob = Ha.__dirtyColors,
              pb = Ha.__dirtyMorphTargets,
              bb = Ha.vertices,
              tb = i.faces,
              wb = Ha.faces,
              ub = Ha.faceVertexUvs[0],
              vb = Ha.faceVertexUvs[1],
              cb = Ha.skinVerticesA,
              db = Ha.skinVerticesB,
              eb = Ha.skinIndices,
              Xa = Ha.skinWeights,
              Za = x instanceof THREE.ShadowVolume ? Ha.edgeFaces : undefined;
            ...
            for (z = tb.length; u < z; u++) {
              ...
              if (n instanceof THREE.Face3) {
                ...
                if (ob && Q) {
                  if (B.length == 4 && Q == THREE.VertexColors) {
                    n = B[0];
                    t = B[1];
                    I = B[2];
                    B = B[3];
            ...
            if (gb && ab > 0) {
              ...
              c.bufferData(c.ARRAY_BUFFER, ib, w);
            }
            if (lb) {
            ...
            if (A > 0) {
              ...
              c.bindBuffer(c.ARRAY_BUFFER, i.__webglSkinWeightsBuffer);
      ...
      k = f.geometry;
      (k.__dirtyVertices || k.__dirtyColors || f.sortParticles) &&
        d(k, c.DYNAMIC_DRAW, f);
      k.__dirtyVertices = !1;
      k.__dirtyColors = !1;
    }
  }
  function ea(f) {
    function s(B) {
      ...
      for (i = B.length; k < i; k++)
        B[k] == undefined ? K.push("undefined") : K.push(B[k].id);
      return K.join("_");
    }
    var k,
      i,
      ...
      D,
      n = {},
      y = f.morphTargets !== undefined ? f.morphTargets.length : 0;
    f.geometryGroups = {};
    m = 0;
  ...
  function Ia(f) {
    if (f && !f.__webglFramebuffer) {
      ...
      f.__webglTexture = c.createTexture();
      c.bindTexture(c.TEXTURE_2D, f.__webglTexture);
      c.texParameteri(c.TEXTURE_2D, c.TEXTURE_WRAP_S, ha(f.wrapS));
  ...
  function fa(f, s) {
    var k;
    if (f == "fragment") k = c.createShader(c.FRAGMENT_SHADER);
    else f == "vertex" && (k = c.createShader(c.VERTEX_SHADER));
    c.shaderSource(k, s);
    c.compileShader(k);
  ...
  (function (f, s, k, i) {
    try {
      if (
        !(c = ia.getContext("experimental-webgl", { antialias: f, stencil: i }))
      )
    ...
    console.log(
      navigator.userAgent +
        ...
        " | " +
        c.getParameter(c.VENDOR) +
        " | " +
        c.getParameter(c.RENDERER) +
        " | " +
        c.getParameter(c.SHADING_LANGUAGE_VERSION)
    );
  ...
  if (stencil) {
    ...
    c.attachShader(
      R.program,
      fa("fragment", THREE.ShaderLib.shadowPost.fragmentShader)
    );
    c.attachShader(
      R.program,
      fa("vertex", THREE.ShaderLib.shadowPost.vertexShader)
    );
  ...
  if (c.getParameter(c.MAX_VERTEX_TEXTURE_IMAGE_UNITS) <= 0) {
    ...
    c.attachShader(
      N.program,
      fa("fragment", THREE.ShaderLib.lensFlare.fragmentShader)
    );
    c.attachShader(
      N.program,
      fa("vertex", THREE.ShaderLib.lensFlare.vertexShader)
    );
  } else {
    ...
    c.attachShader(
      N.program,
      fa("fragment", THREE.ShaderLib.lensFlareVertexTexture.fragmentShader)
    );
    c.attachShader(
      N.program,
      fa("vertex", THREE.ShaderLib.lensFlareVertexTexture.vertexShader)
    );
  }
  ...
  c.attachShader(
    _sprite.program,
    fa("fragment", THREE.ShaderLib.sprite.fragmentShader)
  );
  c.attachShader(
    _sprite.program,
    fa("vertex", THREE.ShaderLib.sprite.vertexShader)
  );
  c.linkProgram(_sprite.program);
  _sprite.attributes = {};
  _sprite.uniforms = {};
  _sprite.attributes.position = c.getAttribLocation(
    _sprite.program,
    "position"
  );
  ...
  _sprite.uniforms.alignment = c.getUniformLocation(
    _sprite.program,
    "alignment"
  );
  ...
  _sprite.uniforms.useScreenCoordinates = c.getUniformLocation(
    _sprite.program,
    "useScreenCoordinates"
  );
  _sprite.uniforms.affectedByDistance = c.getUniformLocation(
    _sprite.program,
    "affectedByDistance"
  );
  _sprite.uniforms.screenPosition = c.getUniformLocation(
    _sprite.program,
    "screenPosition"
  );
  _sprite.uniforms.modelViewMatrix = c.getUniformLocation(
    _sprite.program,
    "modelViewMatrix"
  );
  _sprite.uniforms.projectionMatrix = c.getUniformLocation(
    _sprite.program,
    "projectionMatrix"
  );
  var qb = !1;
  ...
  this.initMaterial = function (f, s, k, i) {
    var m, x, w;
    if (f instanceof THREE.MeshDepthMaterial) w = "depth";
    else if (f instanceof THREE.ShadowVolumeDynamicMaterial)
      w = "shadowVolumeDynamic";
    else if (f instanceof THREE.MeshNormalMaterial) w = "normal";
    else if (f instanceof THREE.MeshBasicMaterial) w = "basic";
    else if (f instanceof THREE.MeshLambertMaterial) w = "lambert";
    else if (f instanceof THREE.MeshPhongMaterial) w = "phong";
    else if (f instanceof THREE.LineBasicMaterial) w = "basic";
    else f instanceof THREE.ParticleBasicMaterial && (w = "particle_basic");
    if (w) {
    ...
    for (D = s.length; z < D; z++) {
      x = s[z];
      x instanceof THREE.DirectionalLight && n++;
    ...
    a: {
      ...
      prefix_fragment = [
        "#ifdef GL_ES\nprecision highp float;\n#endif",
        "#define MAX_DIR_LIGHTS " + k.maxDirLights,
        "#define MAX_POINT_LIGHTS " + k.maxPointLights,
        k.fog ? "#define USE_FOG" : "",
        k.fog instanceof THREE.FogExp2 ? "#define FOG_EXP2" : "",
        k.map ? "#define USE_MAP" : "",
        k.envMap ? "#define USE_ENVMAP" : "",
        k.lightMap ? "#define USE_LIGHTMAP" : "",
        k.vertexColors ? "#define USE_COLOR" : "",
        "uniform mat4 viewMatrix;\nuniform vec3 cameraPosition;\n",
      ].join("\n");
      prefix_vertex = [
        fb ? "#define VERTEX_TEXTURES" : "",
        "#define MAX_DIR_LIGHTS " + k.maxDirLights,
        "#define MAX_POINT_LIGHTS " + k.maxPointLights,
        "#define MAX_BONES " + k.maxBones,
        k.map ? "#define USE_MAP" : "",
        k.envMap ? "#define USE_ENVMAP" : "",
        k.lightMap ? "#define USE_LIGHTMAP" : "",
        k.vertexColors ? "#define USE_COLOR" : "",
        k.skinning ? "#define USE_SKINNING" : "",
        k.morphTargets ? "#define USE_MORPHTARGETS" : "",
        k.sizeAttenuation ? "#define USE_SIZEATTENUATION" : "",
      ...
      c.linkProgram(B);
      c.getProgramParameter(B, c.LINK_STATUS) ||
        console.error(
    ...
    if (f.attributes)
      for (m in f.attributes)
        y[m] !== undefined && y[m] >= 0 && c.enableVertexAttribArray(y[m]);
    if (f.morphTargets) {
      ...
      for (m = this.maxMorphTargets; f < m; f++)
        i.__webglMorphTargetInfluences[f] = 0;
    }
  };
  this.render = function (f, s, k, i) {
    ...
    for (i = 0; i < z; i++) {
      ...
      n = m.object;
      if (n.visible)
        if (!(n instanceof THREE.Mesh) || r(n)) {
  ...
  this.initWebGLObjects = function (f) {
        ...
        for (i in m.geometryGroups) {
          ...
          if (!x.__webglVertexBuffer) {
            ...
            if (w.numMorphTargets) {
              ...
              u = 0;
              for (z = w.numMorphTargets; u < z; u++)
                w.__webglMorphTargetsBuffers.push(c.createBuffer());
            }
            w = x;
            u = s;
            var D = void 0,
            ...
            for (K = n.materials.length; Q < K; Q++) {
              ...
              if (da instanceof THREE.MeshFaceMaterial) {
                da = 0;
                for (l = D.materials.length; da < l; da++)
                  (Ga = D.materials[da]) && y.push(Ga);
            ...
            a: {
              ...
              for (Q = 0; Q < y; Q++) {
                ...
                if (
                  !(
                    (K instanceof THREE.MeshBasicMaterial && !K.envMap) ||
                    K instanceof THREE.MeshDepthMaterial
                  )
                ) {
                  Q =
                    K &&
                    K.shading != undefined &&
                    K.shading == THREE.SmoothShading
                      ? THREE.SmoothShading
                      : THREE.FlatShading;
                  break a;
                }
            ...
            if (n) {
              if (B.faceUvs.length > 0 || B.faceVertexUvs.length > 0)
                w.__uvArray = new Float32Array(z * 2);
              if (B.faceUvs.length > 1 || B.faceVertexUvs.length > 1)
                w.__uv2Array = new Float32Array(z * 2);
            }
            if (
              u.geometry.skinWeights.length &&
            ...
            w.__faceArray = new Uint16Array(
              J * 3 +
                (u.geometry.edgeFaces ? u.geometry.edgeFaces.length * 6 : 0)
            );
            w.__lineArray = new Uint16Array(Y * 2);
            if (w.numMorphTargets) {
              w.__morphTargetsArrays = [];
              B = 0;
              for (K = w.numMorphTargets; B < K; B++)
                w.__morphTargetsArrays.push(new Float32Array(z * 3));
            }
              ...
              if (D[B].attributes) {
                ...
                for (a in D[B].attributes) {
                  ...
                  if (!n.__webglInitialized || n.createUniqueBuffers) {
                    ...
                    J = 1;
                    if (n.type === "v2") J = 2;
                    else if (n.type === "v3") J = 3;
                    else if (n.type === "v4") J = 4;
                    else n.type === "c" && (J = 3);
                    n.size = J;
                    n.needsUpdate = !0;
          ...
          s instanceof THREE.ShadowVolume
            ? W(k.__webglShadowVolumes, x, s)
            : W(k.__webglObjects, x, s);
        }
      } else if (s instanceof THREE.LensFlare)
        W(k.__webglLensFlares, undefined, s);
    ...
    for (; f.__objectsRemoved.length; ) {
      ...
      i = void 0;
      if (s instanceof THREE.Mesh)
        for (m = k.__webglObjects.length - 1; m >= 0; m--) {
        ...
        for (m = k.__webglSprites.length - 1; m >= 0; m--) {
    ...
    s = 0;
    for (k = f.__webglObjects.length; s < k; s++)
      L(f.__webglObjects[s].object, f);
    s = 0;
    for (k = f.__webglShadowVolumes.length; s < k; s++)
      L(f.__webglShadowVolumes[s].object, f);
    s = 0;
    for (k = f.__webglLensFlares.length; s < k; s++)
...
THREE.WebGLRenderTarget = function (b, d, e) {
  ...
  this.minFilter =
    e.minFilter !== undefined ? e.minFilter : THREE.LinearMipMapLinearFilter;
