!(function (t) {
  ...
  function (t, e, i) {
    ...
    AFRAME.registerComponent("particle-system", {
      schema: {
        ...
        type: { type: "number" },
        rotationAxis: { type: "string" },
        rotationAngle: { type: "number" },
        accelerationValue: { type: "vec3" },
        accelerationSpread: { type: "vec3" },
        velocityValue: { type: "vec3" },
      ...
      init: function () {
        (this.presets = []),
          (this.presets["default"] = {
            ...
            positionSpread:
              0 !== this.data.positionSpread.x ||
              0 !== this.data.positionSpread.y ||
              0 !== this.data.positionSpread.z
            ...
            rotationAngle:
              0 !== this.data.rotationAngle ? this.data.rotationAngle : 0,
            accelerationValue:
              0 !== this.data.accelerationValue.x ||
              0 !== this.data.accelerationValue.y ||
              0 !== this.data.accelerationValue.z
                ? this.data.accelerationValue
                : { x: 0, y: -10, z: 0 },
            accelerationSpread:
              0 !== this.data.accelerationSpread.x ||
              0 !== this.data.accelerationSpread.y ||
              0 !== this.data.accelerationSpread.z
                ? this.data.accelerationSpread
                : { x: 10, y: 0, z: 10 },
            velocityValue:
              0 !== this.data.velocityValue.x ||
              0 !== this.data.velocityValue.y ||
              0 !== this.data.velocityValue.z
                ? this.data.velocityValue
                : { x: 0, y: 25, z: 0 },
            velocitySpread:
              0 !== this.data.velocitySpread.x ||
              0 !== this.data.velocitySpread.y ||
              0 !== this.data.velocitySpread.z
            ...
            opacity: { value: 0 != this.data.opacity ? this.data.opacity : 1 },
            direction: 0 !== this.data.direction ? this.data.direction : 1,
            duration: 0 != this.data.duration ? this.data.duration : null,
            particleCount:
              0 !== this.data.particleCount ? this.data.particleCount : 1e3,
            texture:
              "" !== this.data.texture
                ? this.data.texture
          ...
          (this.presets.dust = {
            ...
            rotationAxis:
              "" !== this.data.rotationAxis ? this.data.rotationAxis : "x",
            rotationAngle:
              0 !== this.data.rotationAngle ? this.data.rotationAngle : 3.14,
            accelerationValue:
              0 !== this.data.accelerationValue.x ||
              0 !== this.data.accelerationValue.y ||
              0 !== this.data.accelerationValue.z
            ...
            duration: 0 != this.data.duration ? this.data.duration : null,
            particleCount:
              0 !== this.data.particleCount ? this.data.particleCount : 100,
            texture:
              "" !== this.data.texture
                ? this.data.texture
          ...
          (this.presets.snow = {
            ...
            duration: 0 != this.data.duration ? this.data.duration : null,
            particleCount:
              0 !== this.data.particleCount ? this.data.particleCount : 200,
            texture:
              "" !== this.data.texture
                ? this.data.texture
                : "https://cdn.rawgit.com/IdeaSpaceVR/aframe-particle-system-component/master/dist/images/smokeparticle.png",
          ...
          (this.presets.rain = {
            ...
            velocitySpread:
              ...
              0 !== this.data.velocitySpread.z
                ...
                : { x: 10, y: 50, z: 10 },
            color: this.data.color.length ? this.data.color : ["#FFFFFF"],
            size: 0 !== this.data.size ? this.data.size : 0.4,
            opacity: { value: 0 != this.data.opacity ? this.data.opacity : 1 },
            direction: 0 !== this.data.direction ? this.data.direction : 1,
            duration: 0 != this.data.duration ? this.data.duration : null,
            particleCount:
      ...
      update: function (t) {
        this.particleGroup && this.el.removeObject3D("particle-system"),
          "" != this.data.preset && this.data.preset in this.presets
  ...
  function (t, e, i) {
    var r,
      a,
      s = {
        distributions: { BOX: 1, SPHERE: 2, DISC: 3 },
        valueOverLifetimeLength: 4,
      };
    (r = s),
      (a = "function" == typeof r ? r.call(e, i, e, t) : r),
      !(void 0 !== a && (t.exports = a)),
      (s.TypedArrayHelper = function (t, e, i, r) {
        "use strict";
        (this.componentSize = i || 1),
          (this.size = e || 1),
          (this.TypedArrayConstructor = t || Float32Array),
          (this.array = new t(e * this.componentSize)),
          (this.indexOffset = r || 0);
      }),
      (s.TypedArrayHelper.constructor = s.TypedArrayHelper),
      (s.TypedArrayHelper.prototype.setSize = function (t, e) {
        "use strict";
        var i = this.array.length;
        return (
          e || (t *= this.componentSize),
          i > t
            ? this.shrink(t)
            : t > i
            ? this.grow(t)
      ...
      (s.TypedArrayHelper.prototype.splice = function (t, e) {
        ...
        for (var i = [], r = this.array, a = r.length, s = 0; a > s; ++s)
          (t > s || s >= e) && i.push(r[s]);
      ...
      (s.TypedArrayHelper.prototype.setFromArray = function (t, e) {
        ...
        return (
          ...
          this.array.set(e, this.indexOffset + t),
          this
        );
      }),
      ...
      (s.TypedArrayHelper.prototype.setMat3 = function (t, e) {
        ...
        return this.setFromArray(
          this.indexOffset + t * this.componentSize,
          e.elements
        );
      }),
      ...
      (s.TypedArrayHelper.prototype.setNumber = function (t, e) {
        "use strict";
        return (
          (this.array[this.indexOffset + t * this.componentSize] = e), this
        );
      }),
      ...
      (s.ShaderAttribute = function (t, e, i) {
        ...
        (this.type = "string" == typeof t && r.hasOwnProperty(t) ? t : "f"),
          (this.componentSize = r[this.type]),
          (this.arrayType = i || Float32Array),
          (this.typedArray = null),
          (this.bufferAttribute = null),
          (this.dynamicBuffer = !!e),
          (this.updateMin = 0),
          (this.updateMax = 0);
      }),
      ...
      (s.ShaderAttribute.prototype._ensureTypedArray = function (t) {
        ...
        (null !== this.typedArray &&
          this.typedArray.size === t * this.componentSize) ||
          (null !== this.typedArray && this.typedArray.size !== t
            ? this.typedArray.setSize(t)
            : null === this.typedArray &&
      ...
      (s.utils = {
        ...
        ensureValueOverLifetimeCompliance: function (t, e, i) {
          ...
          (e = e || 3),
            (i = i || 3),
            Array.isArray(t._value) === !1 && (t._value = [t._value]),
            Array.isArray(t._spread) === !1 && (t._spread = [t._spread]);
          var r = this.clamp(t._value.length, e, i),
            a = this.clamp(t._spread.length, e, i),
            s = Math.max(r, a);
          t._value.length !== s &&
            (t._value = this.interpolateArray(t._value, s)),
            t._spread.length !== s &&
              (t._spread = this.interpolateArray(t._spread, s));
        },
        interpolateArray: function (t, e) {
          "use strict";
          for (
            var i = t.length,
              r = ["function" == typeof t[0].clone ? t[0].clone() : t[0]],
              a = (i - 1) / (e - 1),
              s = 1;
            e - 1 > s;
            ++s
          ...
          return (
            r.push(
              "function" == typeof t[i - 1].clone ? t[i - 1].clone() : t[i - 1]
            ),
            r
          );
        },
        ...
        zeroToEpsilon: function (t, e) {
          ...
          var i = 1e-5,
            r = t;
          return (
            (r = e ? Math.random() * i * 10 : i), 0 > t && t > -i && (r = -r), r
          );
        },
        lerpTypeAgnostic: function (t, e, i) {
          ...
          var r,
            a = this.types;
          return typeof t === a.NUMBER && typeof e === a.NUMBER
            ? t + (e - t) * i
            : t instanceof THREE.Vector2 && e instanceof THREE.Vector2
            ? ((r = t.clone()),
              (r.x = this.lerp(t.x, e.x, i)),
              (r.y = this.lerp(t.y, e.y, i)),
              r)
            : t instanceof THREE.Vector3 && e instanceof THREE.Vector3
            ? ((r = t.clone()),
              (r.x = this.lerp(t.x, e.x, i)),
              (r.y = this.lerp(t.y, e.y, i)),
              (r.z = this.lerp(t.z, e.z, i)),
              r)
            : t instanceof THREE.Vector4 && e instanceof THREE.Vector4
            ? ((r = t.clone()),
              (r.x = this.lerp(t.x, e.x, i)),
              (r.y = this.lerp(t.y, e.y, i)),
              (r.z = this.lerp(t.z, e.z, i)),
              (r.w = this.lerp(t.w, e.w, i)),
              r)
            : t instanceof THREE.Color && e instanceof THREE.Color
            ? ((r = t.clone()),
              (r.r = this.lerp(t.r, e.r, i)),
              (r.g = this.lerp(t.g, e.g, i)),
              (r.b = this.lerp(t.b, e.b, i)),
              r)
            : void console.warn(
        ...
        randomVector3: function (t, e, i, r, a) {
          "use strict";
          var s = i.x + (Math.random() * r.x - 0.5 * r.x),
            o = i.y + (Math.random() * r.y - 0.5 * r.y),
            n = i.z + (Math.random() * r.z - 0.5 * r.z);
          a &&
            ...
            t.typedArray.setVec3Components(e, s, o, n);
        },
        randomColor: function (t, e, i, r) {
          ...
          (a = this.clamp(a, 0, 1)),
            (s = this.clamp(s, 0, 1)),
            (o = this.clamp(o, 0, 1)),
            t.typedArray.setVec3Components(e, a, s, o);
        },
        randomColorAsHex: (function () {
          ...
          return function (e, i, r, a) {
            for (var s = r.length, o = [], n = 0; s > n; ++n) {
              var u = a[n];
              t.copy(r[n]),
                (t.r += Math.random() * u.x - 0.5 * u.x),
                (t.g += Math.random() * u.y - 0.5 * u.y),
                (t.b += Math.random() * u.z - 0.5 * u.z),
                (t.r = this.clamp(t.r, 0, 1)),
                (t.g = this.clamp(t.g, 0, 1)),
                (t.b = this.clamp(t.b, 0, 1)),
                o.push(t.getHex());
            }
        ...
        randomVector3OnSphere: function (t, e, i, r, a, s, o, n) {
          ...
          o && (p = Math.round(p / o) * o),
            ...
            (h += i.y),
            (y += i.z),
            t.typedArray.setVec3Components(e, d, h, y);
        },
        ...
        randomVector3OnDisc: function (t, e, i, r, a, s, o) {
          ...
          o && (u = Math.round(u / o) * o),
            ...
            (c += i.y),
            (p += i.z),
            t.typedArray.setVec3Components(e, l, c, p);
        },
        randomDirectionVector3OnSphere: (function () {
          ...
          return function (e, i, r, a, s, o, n, u) {
            t.copy(o),
              ...
              (t.y -= a),
              (t.z -= s),
              t.normalize().multiplyScalar(-this.randomFloat(n, u)),
              e.typedArray.setVec3Components(i, t.x, t.y, t.z);
          };
        })(),
        randomDirectionVector3OnDisc: (function () {
          ...
          return function (e, i, r, a, s, o, n, u) {
            t.copy(o),
              ...
              (t.z -= s),
              t.normalize().multiplyScalar(-this.randomFloat(n, u)),
              e.typedArray.setVec3Components(i, t.x, t.y, 0);
          };
        })(),
        getPackedRotationAxis: (function () {
          ...
          return function (a, s) {
            return (
              t.copy(a).normalize(),
              e.copy(s).normalize(),
              (t.x += 0.5 * -s.x + Math.random() * s.x),
              (t.y += 0.5 * -s.y + Math.random() * s.y),
              (t.z += 0.5 * -s.z + Math.random() * s.z),
              t.normalize().add(r).multiplyScalar(0.5),
              i.setRGB(t.x, t.y, t.z),
              i.getHex()
            );
          };
        })(),
      ...
      (s.Group = function (t) {
        ...
        var e = s.utils,
          i = e.types;
        (t = e.ensureTypedArg(t, i.OBJECT, {})),
          (t.texture = e.ensureTypedArg(t.texture, i.OBJECT, {})),
          (this.uuid = THREE.Math.generateUUID()),
          (this.fixedTimeStep = e.ensureTypedArg(
            t.fixedTimeStep,
            i.NUMBER,
            0.016
          )),
          (this.texture = e.ensureInstanceOf(
            t.texture.value,
            THREE.Texture,
            null
          )),
          (this.textureFrames = e.ensureInstanceOf(
            t.texture.frames,
            THREE.Vector2,
            new THREE.Vector2(1, 1)
          )),
          (this.textureFrameCount = e.ensureTypedArg(
            t.texture.frameCount,
            i.NUMBER,
            this.textureFrames.x * this.textureFrames.y
          )),
          (this.textureLoop = e.ensureTypedArg(t.texture.loop, i.NUMBER, 1)),
          this.textureFrames.max(new THREE.Vector2(1, 1)),
          (this.hasPerspective = e.ensureTypedArg(
            t.hasPerspective,
            i.BOOLEAN,
            !0
          )),
          (this.colorize = e.ensureTypedArg(t.colorize, i.BOOLEAN, !0)),
          (this.maxParticleCount = e.ensureTypedArg(
            t.maxParticleCount,
            i.NUMBER,
            null
          )),
          (this.blending = e.ensureTypedArg(
            t.blending,
            i.NUMBER,
            THREE.AdditiveBlending
          )),
          (this.transparent = e.ensureTypedArg(t.transparent, i.BOOLEAN, !0)),
          (this.alphaTest = parseFloat(
            e.ensureTypedArg(t.alphaTest, i.NUMBER, 0)
          )),
          (this.depthWrite = e.ensureTypedArg(t.depthWrite, i.BOOLEAN, !1)),
          (this.depthTest = e.ensureTypedArg(t.depthTest, i.BOOLEAN, !0)),
          (this.fog = e.ensureTypedArg(t.fog, i.BOOLEAN, !0)),
          (this.scale = e.ensureTypedArg(t.scale, i.NUMBER, 300)),
          (this.emitters = []),
          (this.emitterIDs = []),
          (this._pool = []),
      ...
      (s.Group.prototype._updateDefines = function () {
        ...
        for (i; i >= 0; --i)
          (t = e[i]),
            r.SHOULD_CALCULATE_SPRITE ||
              (r.SHOULD_ROTATE_TEXTURE =
                r.SHOULD_ROTATE_TEXTURE ||
                !!Math.max(
                  Math.max.apply(null, t.angle.value),
                  Math.max.apply(null, t.angle.spread)
                )),
            (r.SHOULD_ROTATE_PARTICLES =
              r.SHOULD_ROTATE_PARTICLES ||
              !!Math.max(t.rotation.angle, t.rotation.angleSpread)),
            (r.SHOULD_WIGGLE_PARTICLES =
              r.SHOULD_WIGGLE_PARTICLES ||
              !!Math.max(t.wiggle.value, t.wiggle.spread));
      ...
      (s.Group.prototype._applyAttributesToGeometry = function () {
        ...
        for (var s in i)
          i.hasOwnProperty(s) &&
            ...
            (e = a[s]),
            e
              ? (e.array = t.typedArray.array)
              : r.addAttribute(s, t.bufferAttribute),
            (t.bufferAttribute.needsUpdate = !0));
        this.geometry.setDrawRange(0, this.particleCount);
      }),
      (s.Group.prototype.addEmitter = function (t) {
        "use strict";
        if (t instanceof s.Emitter == !1)
          return void console.error(
            "`emitter` argument must be instance of SPE.Emitter. Was provided with:",
            t
          );
        if (this.emitterIDs.indexOf(t.uuid) > -1)
          return void console.error(
        ...
        (this.particleCount = r),
          ...
          t._calculatePPSValue(t.maxAge._value + t.maxAge._spread),
          t._setBufferUpdateRanges(this.attributeKeys),
          t._setAttributeOffset(i),
          (t.group = this),
          (t.attributes = this.attributes);
        for (var a in e)
          e.hasOwnProperty(a) &&
            e[a]._createBufferAttribute(
              null !== this.maxParticleCount
                ? this.maxParticleCount
                : this.particleCount
            );
        for (var o = i; r > o; ++o)
          t._assignPositionValue(o),
            t._assignForceValue(o, "velocity"),
            t._assignForceValue(o, "acceleration"),
            t._assignAbsLifetimeValue(o, "opacity"),
            t._assignAbsLifetimeValue(o, "size"),
            t._assignAngleValue(o),
            t._assignRotationValue(o),
            t._assignParamsValue(o),
            t._assignColorValue(o);
        return (
          this._applyAttributesToGeometry(),
          this.emitters.push(t),
          this.emitterIDs.push(t.uuid),
          this._updateDefines(t),
          (this.material.needsUpdate = !0),
      ...
      (s.Group.prototype.getFromPool = function () {
        ...
        return t.length
          ? t.pop()
          : e
          ? new s.Emitter(this._poolCreationSettings)
          : null;
      }),
      (s.Group.prototype.releaseIntoPool = function (t) {
        "use strict";
        return t instanceof s.Emitter == !1
          ? void console.error("Argument is not instanceof SPE.Emitter:", t)
          : (t.reset(), this._pool.unshift(t), this);
      }),
      ...
      (s.Group.prototype.addPool = function (t, e, i) {
        ...
        for (var a = 0; t > a; ++a)
          (r = Array.isArray(e) ? new s.Emitter(e[a]) : new s.Emitter(e)),
            this.addEmitter(r),
            this.releaseIntoPool(r);
        return this;
      }),
      (s.Group.prototype._triggerSingleEmitter = function (t) {
        ...
        return null === e
          ...
          : (t instanceof THREE.Vector3 &&
              (e.position.value.copy(t), (e.position.value = e.position.value)),
            e.enable(),
            setTimeout(function () {
              e.disable(), i.releaseIntoPool(e);
            }, 1e3 * Math.max(e.duration, e.maxAge.value + e.maxAge.spread)),
            this);
      }),
      ...
      (s.Emitter = function (t) {
        ...
        (t = e.ensureTypedArg(t, i.OBJECT, {})),
          (t.position = e.ensureTypedArg(t.position, i.OBJECT, {})),
          (t.velocity = e.ensureTypedArg(t.velocity, i.OBJECT, {})),
          (t.acceleration = e.ensureTypedArg(t.acceleration, i.OBJECT, {})),
          (t.radius = e.ensureTypedArg(t.radius, i.OBJECT, {})),
          (t.drag = e.ensureTypedArg(t.drag, i.OBJECT, {})),
          (t.rotation = e.ensureTypedArg(t.rotation, i.OBJECT, {})),
          (t.color = e.ensureTypedArg(t.color, i.OBJECT, {})),
          (t.opacity = e.ensureTypedArg(t.opacity, i.OBJECT, {})),
          (t.size = e.ensureTypedArg(t.size, i.OBJECT, {})),
          (t.angle = e.ensureTypedArg(t.angle, i.OBJECT, {})),
          (t.wiggle = e.ensureTypedArg(t.wiggle, i.OBJECT, {})),
          (t.maxAge = e.ensureTypedArg(t.maxAge, i.OBJECT, {})),
          t.onParticleSpawn &&
            console.warn(
              "onParticleSpawn has been removed. Please set properties directly to alter values at runtime."
            ),
          (this.uuid = THREE.Math.generateUUID()),
          (this.type = e.ensureTypedArg(t.type, i.NUMBER, s.distributions.BOX)),
          (this.position = {
            _value: e.ensureInstanceOf(
              t.position.value,
              THREE.Vector3,
              new THREE.Vector3()
            ),
            _spread: e.ensureInstanceOf(
              t.position.spread,
              THREE.Vector3,
              new THREE.Vector3()
            ),
            _spreadClamp: e.ensureInstanceOf(
              t.position.spreadClamp,
              THREE.Vector3,
              new THREE.Vector3()
            ),
            _distribution: e.ensureTypedArg(
            ...
            _radiusScale: e.ensureInstanceOf(
              t.position.radiusScale,
              THREE.Vector3,
              new THREE.Vector3(1, 1, 1)
            ),
            _distributionClamp: e.ensureTypedArg(
              t.position.distributionClamp,
              i.NUMBER,
              0
            ),
          }),
          ...
          (this.acceleration = {
            _value: e.ensureInstanceOf(
              t.acceleration.value,
              THREE.Vector3,
              new THREE.Vector3()
            ),
            _spread: e.ensureInstanceOf(
              t.acceleration.spread,
              THREE.Vector3,
              new THREE.Vector3()
            ),
            _distribution: e.ensureTypedArg(
              t.acceleration.distribution,
              i.NUMBER,
              this.type
            ),
            _randomise: e.ensureTypedArg(t.position.randomise, i.BOOLEAN, !1),
          ...
          (this.rotation = {
            _axis: e.ensureInstanceOf(
              t.rotation.axis,
              THREE.Vector3,
              new THREE.Vector3(0, 1, 0)
            ),
            _axisSpread: e.ensureInstanceOf(
              t.rotation.axisSpread,
              THREE.Vector3,
              new THREE.Vector3()
            ),
          ...
          (this.color = {
            _value: e.ensureArrayInstanceOf(
              t.color.value,
              THREE.Color,
              new THREE.Color()
            ),
            _spread: e.ensureArrayInstanceOf(
              t.color.spread,
              THREE.Vector3,
              new THREE.Vector3()
            ),
          ...
          (this.particleCount = e.ensureTypedArg(
            t.particleCount,
            i.NUMBER,
            100
          )),
          (this.duration = e.ensureTypedArg(t.duration, i.NUMBER, null)),
          (this.isStatic = e.ensureTypedArg(t.isStatic, i.BOOLEAN, !1)),
          (this.activeMultiplier = e.ensureTypedArg(
            t.activeMultiplier,
            i.NUMBER,
            1
          )),
          (this.direction = e.ensureTypedArg(t.direction, i.NUMBER, 1)),
          (this.alive = e.ensureTypedArg(t.alive, i.BOOLEAN, !0)),
          ...
          (this.resetFlags = {
            position:
              e.ensureTypedArg(t.position.randomise, i.BOOLEAN, !1) ||
              e.ensureTypedArg(t.radius.randomise, i.BOOLEAN, !1),
            velocity: e.ensureTypedArg(t.velocity.randomise, i.BOOLEAN, !1),
            acceleration:
              e.ensureTypedArg(t.acceleration.randomise, i.BOOLEAN, !1) ||
              e.ensureTypedArg(t.drag.randomise, i.BOOLEAN, !1),
            rotation: e.ensureTypedArg(t.rotation.randomise, i.BOOLEAN, !1),
            rotationCenter: e.ensureTypedArg(
              t.rotation.randomise,
              i.BOOLEAN,
              !1
            ),
        ...
        (this.bufferUpdateRanges = {}),
          ...
          e.ensureValueOverLifetimeCompliance(this.color, r, r),
          e.ensureValueOverLifetimeCompliance(this.opacity, r, r),
          e.ensureValueOverLifetimeCompliance(this.size, r, r),
          e.ensureValueOverLifetimeCompliance(this.angle, r, r);
      }),
      (s.Emitter.constructor = s.Emitter),
      (s.Emitter.prototype._createGetterSetters = function (t, e) {
        "use strict";
        var i = this;
        for (var r in t)
                ...
                return function (r) {
                  ...
                  "_rotationCenter" === t
                    ? ((i.updateFlags.rotationCenter = !0),
                      (i.updateCounts.rotationCenter = 0))
                    : "_randomise" === t
                    ? (i.resetFlags[a] = r)
                    : ((i.updateFlags[a] = !0), (i.updateCounts[a] = 0)),
                    i.group._updateDefines(),
                    (this[t] = r),
                    Array.isArray(o) &&
                      s.utils.ensureValueOverLifetimeCompliance(i[e], n, n);
                };
              })(r),
            });
          }
      ...
      (s.Emitter.prototype._calculatePPSValue = function (t) {
        ...
        this.duration
          ? (this.particlesPerSecond =
              e / (t < this.duration ? t : this.duration))
          : (this.particlesPerSecond = e / t);
      }),
      (s.Emitter.prototype._setAttributeOffset = function (t) {
        (this.attributeOffset = t),
          (this.activationIndex = t),
          (this.activationEnd = t + this.particleCount);
      }),
        ...
        switch (u) {
          ...
          case e.SPHERE:
            i.randomVector3OnSphere(
              ...
              r._radiusScale,
              r._spreadClamp.x,
              r._distributionClamp || this.particleCount
            );
            break;
          case e.DISC:
            i.randomVector3OnDisc(
              a,
              t,
              o,
              r._radius,
      ...
      (s.Emitter.prototype._assignForceValue = function (t, e) {
        ...
        switch (h) {
          case u.BOX:
            ...
            break;
          case u.SPHERE:
            (i = this.attributes.position.typedArray.array),
              (n = 3 * t),
              (r = i[n]),
              (a = i[n + 1]),
              (o = i[n + 2]),
      ...
      (s.Emitter.prototype._assignAbsLifetimeValue = function (t, e) {
        ...
        o.arrayValuesAreEqual(a._value) && o.arrayValuesAreEqual(a._spread)
          ? ((i = Math.abs(o.randomFloat(a._value[0], a._spread[0]))),
            r.setVec4Components(t, i, i, i, i))
          : r.setVec4Components(
              t,
      ...
      (s.Emitter.prototype._assignAngleValue = function (t) {
        ...
        var e,
          ...
          r = this.angle,
          a = s.utils;
        a.arrayValuesAreEqual(r._value) && a.arrayValuesAreEqual(r._spread)
          ? ((e = a.randomFloat(r._value[0], r._spread[0])),
            i.setVec4Components(t, e, e, e, e))
          : i.setVec4Components(
              t,
              a.randomFloat(r._value[0], r._spread[0]),
              a.randomFloat(r._value[1], r._spread[1]),
              a.randomFloat(r._value[2], r._spread[2]),
              a.randomFloat(r._value[3], r._spread[3])
            );
      }),
      ...
      (s.Emitter.prototype._assignRotationValue = function (t) {
        ...
        this.attributes.rotation.typedArray.setVec3Components(
          ...
          s.utils.randomFloat(this.rotation._angle, this.rotation._angleSpread),
      ...
      (s.Emitter.prototype._resetParticle = function (t) {
        ...
        for (
          ...
          (e = o[n]),
            (i = a[e]),
            (r[e] !== !0 && i !== !0) ||
              (this._assignValue(e, t),
              this._updateAttributeUpdateRange(e, t),
              i === !0 && s[e] === this.particleCount
                ? ((a[e] = !1), (s[e] = 0))
                : 1 == i && ++s[e]);
      }),
      ...
      (s.Emitter.prototype._resetBufferRanges = function () {
        ...
        for (r; r >= 0; --r)
          (t = i[r]),
            (e[t].min = Number.POSITIVE_INFINITY),
            (e[t].max = Number.NEGATIVE_INFINITY);
      }),
        ...
        for (var a, s, o, n, u = e - 1; u >= t; --u)
          (a = 4 * u),
            ...
            0 !== n &&
              ...
              1 === this.direction
                ? ((o += r),
                  o >= s && ((o = 0), (n = 0), this._decrementParticleCount()))
                : ((o -= r),
                  0 >= o && ((o = s), (n = 0), this._decrementParticleCount())),
              (i[a] = n),
              (i[a + 1] = o),
      ...
      (s.Emitter.prototype._activateParticles = function (t, e, i, r) {
        "use strict";
        for (var a, s, o = this.direction, n = t; e > n; ++n)
          (a = 4 * n),
            (0 != i[a] && 1 !== this.particleCount) ||
      ...
      (s.Emitter.prototype.tick = function (t) {
        ...
        if (!this.isStatic) {
          ...
          if (
            (this._resetBufferRanges(),
            this._checkParticleAges(e, i, r, t),
            this.alive === !1)
          )
          ...
          var o = 1 === this.particleCount ? s : 0 | s,
            ...
            l = u > 0 ? t / u : 0;
          this._activateParticles(o, n, r, l),
            (this.activationIndex += a),
            this.activationIndex > i && (this.activationIndex = e),
            (this.age += t);
        }
      }),
