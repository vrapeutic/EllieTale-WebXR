AFRAME.registerComponent("menu", {
  init: function () {
    ...
    var firtTargetPos = document
      .getElementById("targetone")
      .getAttribute("position");
    var lastTargetPos = document
      .getElementById("targetthree")
      .getAttribute("position");
    ...
    let disableMenu = function Disable() {
      document
        .getElementById("boxLevel")
        .parentNode.removeChild(document.getElementById("boxLevel"));
      document
        .getElementById("boxLevel1")
        .parentNode.removeChild(document.getElementById("boxLevel1"));
      document
        .getElementById("boxLevel2")
        .parentNode.removeChild(document.getElementById("boxLevel2"));
    };
    let checkLevel = function fcheckLevel() {
      document
        .querySelector("#helloAud")
        .setAttribute("position", fairy.getAttribute("position"));
      document.querySelector("#helloAud").components.sound.playSound();
      console.log(
        document.querySelector("#helloAud").getAttribute("sound").src
      );
      ...
      document
        ...
        .addEventListener("sound-ended", function () {
          ...
          document
            .querySelector("#enviroAud")
            .parentNode.removeChild(document.querySelector("#enviroAud"));
          document
            .querySelector("#helloAud")
            .parentNode.removeChild(document.querySelector("#helloAud"));
          if (document.getElementById("noah") != null)
            document
              .getElementById("noah")
              .parentNode.removeChild(document.getElementById("noah"));
          document
          ...
          fairy.setAttribute(
            "rotation",
            document.getElementById("targetone").getAttribute("rotation")
          );
          ...
          if (document.getElementById("level").getAttribute("value") == 3) {
            ...
            fairy.setAttribute(
              "rotation",
              document.getElementById("cam").getAttribute("rotation")
            );
            ...
            setTimeout(() => {
              document
                ...
                .setAttribute("advancedmovenment", "enabled", true);
            }, 2000);
            document
              .getElementById("myDistractor")
            ...
            console.log(
              document.getElementById("myDistractor").getAttribute("position")
                .z +
                " target " +
                lastTargetPos.z
            );
 ...
 partical.setAttribute("visible","true");
   ...
   partical.setAttribute("position", 
          ...
          //level two (Set distractor component and remove other components  )
            ...
            document
              .getElementById("myDistractor")
              .setAttribute("moverandomly", "enabled", true);
            ...
            if (
              document.getElementById("myDistractor").firstElementChild != null
            )
              document
                .getElementById("myDistractor")
                .firstElementChild.setAttribute("position", "0 0 0");
